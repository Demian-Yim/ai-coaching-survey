...
- ⭐⭐⭐⭐⭐ 5점 (선구자): "AI로 새로운 길을 만들어요." 기존에 없던 방식으로 AI를 활용하거나, 자신만의 워크플로우를 창조하며 다른 사람에게 영감을 줘요.`,
        questions: [
            { id: 'understanding', label: '🧠 이해 (Understand)', description: "AI의 기본 원리, 최신 기술 동향(e.g., LLM, 멀티모달), 비즈니스 적용 가능성과 함께 기술적 한계(e.g., 환각) 및 잠재적 리스크를 명확히 이해하고 설명하는 능력. (예시: \"ChatGPT는 가끔 엉뚱한 거짓말을 하는데, 최신 정보를 찾아주는 AI(Perplexity)는 왜 다른지, 그 차이점을 동료에게 쉽게 설명할 수 있다.\")", type: 'rating', options: [1, 2, 3, 4, 5] },
            { id: 'application', label: '🛠️ 활용 (Use)', description: "자신의 구체적인 업무 목적(e.g., 보고서 작성, 교육 기획, 데이터 분석)에 가장 적합한 AI 도구를 선정하고, 페르소나, 컨텍스트, 제약조건을 포함한 효과적인 프롬프트를 작성하여 기대 이상의 결과물을 생성하며, 워크플로우를 자동화하는 능력. (예시: \"까다로운 팀장님에게 보낼 주간보고 이메일 초안을 AI에게 요청할 때, 원하는 결과가 한 번에 나오도록 구체적인 배경, 어조, 핵심 내용을 담아 지시할 수 있다.\")", type: 'rating', options: [1, 2, 3, 4, 5] },
            { id: 'criticalThinking', label: '🔍 비판적 사고 (Critical Thinking)', description: "AI가 생성한 결과물의 사실관계, 논리적 오류, 숨겨진 편향성, 윤리적 문제를 비판적으로 검토하고, 교차 검증을 통해 정보의 신뢰도를 판단하며, 결과물에 대한 최종 책임(Accountability)을 가지고 활용하는 능력. (예시: \"AI가 요약해준 시장 분석 보고서의 내용이 그럴듯해 보여도, 핵심적인 수치나 출처는 반드시 원본 데이터와 비교/검증하여 사실관계를 확인한다.\")", type: 'rating', options: [1, 2, 3, 4, 5] },
        ]
    },
    {
        id: 'part5',
